...
const field_name = 'fee_schedule';
const label = 'Schedule Of School Fees Payment';

function FeeScheduleUpload({ doc, app_id, setDocuments }) {
...
export default FeeScheduleUpload;
