...
const field_name = 'applicant_picture';
const label = 'Full Picture Of Beneficiary Showing The Type Of Disability';

function FullPictureUpload({ doc, app_id, setDocuments }) {
...
export default FullPictureUpload;
