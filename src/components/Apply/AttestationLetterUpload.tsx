...
const field_name = 'attestation_letter';
const label = 'Letter Of Attestation By Department HOD';

function AttestationLetterUpload({ doc, app_id, setDocuments }) {
  ...
  const upload = async () => {
    ...
    form.append('image_for', field_name);
    try {
      ...
      setDocuments((prev) => {
        ...
        data.letterOfAttestation = res.data.url;
        return { ...data };
      });
      closeModal();
      setLoading(false);
...
export default AttestationLetterUpload;
